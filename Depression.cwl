...
steps:
  ...
  depressive-depression---primary:
    run: depressive-depression---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression-review---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depressive-depression---primary/output
  depression-register---primary:
    run: depression-register---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression-dementium---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-register---primary/output
  ...
  chronic-depression---primary:
    run: chronic-depression---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  postviral-depression---primary:
    run: postviral-depression---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: chronic-depression---primary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: postviral-depression---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
